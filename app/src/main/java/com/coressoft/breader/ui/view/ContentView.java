...
import com.coressoft.breader.animation.AnimationProvider;
import com.coressoft.breader.animation.CoverAnimation;
import com.coressoft.breader.animation.NoneAnimation;
import com.coressoft.breader.animation.SimulationAnimation;
import com.coressoft.breader.animation.SlideAnimation;
...
public class ContentView extends View {
    ...
    private void initPage(){
        ...
        mCurPageBitmap = Bitmap.createBitmap(mScreenWidth, mScreenHeight, Bitmap.Config.ARGB_4444);      //android:LargeHeap=true  use in  manifest application
        mNextPageBitmap = Bitmap.createBitmap(mScreenWidth, mScreenHeight, Bitmap.Config.ARGB_4444);
    }
...
//                    mTouch.y = 0.1f;
    ...
    public void setTouchListener(TouchListener mTouchListener){
        ...
        Log.i("xing.yw","mTouchListener----->>"+mTouchListener);
    }
    ...
    public openAndClosePopWindowsTitle listener;
    public boolean mIsOpen;
    public interface openAndClosePopWindowsTitle{
        void openTitle();
        void closeTitle();
    }

    public void setListener(openAndClosePopWindowsTitle listener,boolean isOpen) {
