...
import com.coressoft.breader.ui.drawerItems.CustomPrimaryDrawerItem;
import com.coressoft.breader.ui.drawerItems.CustomUrlPrimaryDrawerItem;
import com.coressoft.breader.ui.drawerItems.OverflowMenuDrawerItem;
 ...
 * @ProjectName: BReader
 * @Package: com.coressoft.breader.ui.activity
 * @ClassName: MainTestActicity
 * @Description: java类作用描述
 * @Author: xingyan_wei
 * @CreateDate: 2020/1/2 8:21 PM
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/1/2 8:21 PM
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class MainTestActicity extends AppCompatActivity {
                ...
                .addDrawerItems(
                        ...
                        new OverflowMenuDrawerItem().withName(R.string.drawer_item_menu_drawer_item).withDescription(R.string.drawer_item_menu_drawer_item_desc).withMenu(R.menu.fragment_menu).withOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                Toast.makeText(MainTestActicity.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                                return false;
                            }
